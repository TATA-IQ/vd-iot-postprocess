...
class PPETemplate():
    def __init__(self,data):
        ...
        self.expected_classes=["human","vest","novest","helmet","nohelmet","mask","nomask","goggles","nogoggles","shoes","noshoes",
        "earplug","noearplug","harness","noharness","gloves","nogloves","arm"]
