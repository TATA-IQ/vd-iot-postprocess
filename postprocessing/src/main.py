...
class PostProcessingApp:
    ...
    def prepare_send(self,image_width, image_height,producer,camera_id,usecase_id,image_time,topic_name,legend,metadata,image_name, frame ,expected_class, detection_output, incident_out,masked_image, misc_data=None,model_meta=[],computation_meta=[]):
    ...
    def crowd_counting(self,image_width, image_height, usecase_template_id, metadata,camera_id,usecase_id,image_name,incidents,steps,legend,topic_name,frame,image,image_time,producer,mask_key,boundary_config,model_meta,computation_meta):
        global lock
        lock.acquire()
        ...
        try:
            ...
            self.prepare_send(image_width, image_height,producer,camera_id,usecase_id,image_time,topic_name,legend,metadata,image_name,frame,expected_class, detection_output, incident_out, masked_image, misc_data)
    ...
    def anpr_detect(self,image_width, image_height, usecase_template_id, metadata,camera_id,usecase_id,image_name,incidents,steps,legend,topic_name,frame,image,image_time,producer,mask_key,boundary_config,model_meta,computation_meta):
        global lock
    ...
    def ppe_detect(self,image_width, image_height, usecase_template_id, metadata,camera_id,usecase_id,image_name,incidents,steps,legend,topic_name,frame,image,image_time,producer,mask_key,boundary_config,model_meta,computation_meta):
        global lock
        lock.acquire()
        # metadata=copy.deepcopy(self.metadata)
        #try:
    ...
    def fire_smoke_detect(self,image_width, image_height, usecase_template_id, metadata,camera_id,usecase_id,image_name,incidents,steps,legend,topic_name,frame,image,image_time,producer,mask_key,boundary_config,model_meta,computation_meta):
        global lock
        lock.acquire()
        # metadata=copy.deepcopy(self.metadata)
        # camera_id=copy.deepcopy(self.camera_id)
    ...
    def dedicated_pathway(self,image_width, image_height, usecase_template_id, metadata,camera_id,usecase_id,image_name,incidents,steps,legend,topic_name,frame,image,image_time,producer,mask_key,boundary_config,model_meta,computation_meta):
        global lock
        lock.acquire()
        # metadata=copy.deepcopy(self.metadata)
        # camera_id=copy.deepcopy(self.camera_id)
        ...
        # cv2.imwrite("post_image/after_det/"+image_name,frame)
        self.prepare_send(image_width, image_height,producer,camera_id,usecase_id,image_time,topic_name,legend,metadata,image_name,frame,expected_class, detection_output, incident_out, image_back, misc_data)
    ...
    def intrusion_detect(self,image_width, image_height, usecase_template_id, metadata,camera_id,usecase_id,image_name,incidents,steps,legend,topic_name,frame,image,image_time,producer,mask_key,boundary_config,model_meta,computation_meta):
        global lock
    ...
    def vehicle_detect(self,image_width, image_height, usecase_template_id, metadata,camera_id,usecase_id,image_name,incidents,steps,legend,topic_name,frame,image,image_time,producer,mask_key,boundary_config,model_meta,computation_meta):
        global lock
        lock.acquire()
        mask=None
        image_back=None
    ...
    def garbage_detect(self,image_width, image_height, usecase_template_id, metadata,camera_id,usecase_id,image_name,incidents,steps,legend,topic_name,frame,image,image_time,producer,mask_key,boundary_config,model_meta,computation_meta):
        global lock
        lock.acquire()
        mask=None
        image_back=None
    ...
    def brightness_detect(self,image_width, image_height, usecase_template_id, metadata,camera_id,usecase_id,image_name,incidents,steps,legend,topic_name,frame,image,image_time,producer,mask_key,boundary_config,model_meta,computation_meta):
        global lock
        lock.acquire()
        # metadata=copy.deepcopy(self.metadata)
        # camera_id=copy.deepcopy(self.camera_id)
    ...
    def svd_detect(self,image_width, image_height, usecase_template_id, metadata,camera_id,usecase_id,image_name,incidents,steps,legend,topic_name,frame,image,image_time,producer,mask_key,boundary_config,model_meta,computation_meta):
        ...
        # image_time=copy.deepcopy(self.image_time)
        # mask_key=copy.deepcopy(self.mask_key)
        cv2.imwrite("input/"+image_name,frame)
        try:
            if mask_key is not None:
                mask = Masking(
                    copy.deepcopy(frame),
    ...
    def call_template(self,image, postprocess_config, topic_name, metadata,boundary_config, producer):
        ...
        if usecase_template_id == 1:
            ...
            self.ppe_detect(image_width, image_height,usecase_template_id, metadata,camera_id,usecase_id,image_name,incidents,steps,legend,topic_name,frame,image,image_time,producer,mask_key,boundary_config,model_meta,computation_meta)
        elif usecase_template_id == 3:
            print("======Template FireSmoke Start======")
            self.fire_smoke_detect(image_width, image_height,usecase_template_id, metadata,camera_id,usecase_id,image_name,incidents,steps,legend,topic_name,frame,image,image_time,producer,mask_key,boundary_config,model_meta,computation_meta)
        elif usecase_template_id == 4:
            print("======Template crowd Start======")
            self.crowd_counting(image_width, image_height,usecase_template_id, metadata,camera_id,usecase_id,image_name,incidents,steps,legend,topic_name,frame,image,image_time,producer,mask_key,boundary_config,model_meta,computation_meta)
        elif usecase_template_id == 13:
            print("======Template garbage Start======")
            self.garbage_detect(image_width, image_height,usecase_template_id, metadata,camera_id,usecase_id,image_name,incidents,steps,legend,topic_name,frame,image,image_time,producer,mask_key,boundary_config,model_meta,computation_meta)
        elif usecase_template_id == 8:
            print("======Template brightness Start======")
            self.brightness_detect(image_width, image_height,usecase_template_id, metadata,camera_id,usecase_id,image_name,incidents,steps,legend,topic_name,frame,image,image_time,producer,mask_key,boundary_config,model_meta,computation_meta)
        elif usecase_template_id == 9:
            print("======Template pathway Start======")
            self.dedicated_pathway(image_width, image_height,usecase_template_id, metadata,camera_id,usecase_id,image_name,incidents,steps,legend,topic_name,frame,image,image_time,producer,mask_key,boundary_config,model_meta,computation_meta)
        elif usecase_template_id == 10:
            print("======Template anpr Start======")
            self.anpr_detect(image_width, image_height,usecase_template_id, metadata,camera_id,usecase_id,image_name,incidents,steps,legend,topic_name,frame,image,image_time,producer,mask_key,boundary_config,model_meta,computation_meta)
        elif usecase_template_id == 2:
            print("======Template svd Start======")
            self.svd_detect(image_width, image_height,usecase_template_id, metadata,camera_id,usecase_id,image_name,incidents,steps,legend,topic_name,frame,image,image_time,producer,mask_key,boundary_config,model_meta,computation_meta)
        elif usecase_template_id == 11:
            print("======Template intrusion Start======")
            self.intrusion_detect(image_width, image_height,usecase_template_id, metadata,camera_id,usecase_id,image_name,incidents,steps,legend,topic_name,frame,image,image_time,producer,mask_key,boundary_config,model_meta,computation_meta)
        elif usecase_template_id == 12:
            print("======Template vehicle  Start======")
            self.vehicle_detect(image_width, image_height,usecase_template_id, metadata,camera_id,usecase_id,image_name,incidents,steps,legend,topic_name,frame,image,image_time,producer,mask_key,boundary_config,model_meta,computation_meta)
    ...
    def process(self,image, postprocess_config, topic_name, metadata, boundary_config ,producer):
        ...
        #if  int(usecase_template_id)==11: #and int(self.camera_id)==6:
            # print("====boundary====")
